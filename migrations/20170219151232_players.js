...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('players', function(table) {
    ...
    table.string('bats_LR').notNullable().defaultTo('R');
    table.string('throws_LR').notNullable().defaultTo('R');
    table.integer('salary').notNullable().defaultTo(100000);
    table.decimal('wpa_2016', 8, 2).notNullable().defaultTo(0.0);
    ...
    table.integer('projected_2017_SB').defaultTo(null);
    table.decimal('projected_2017_AVG', 8, 3).defaultTo(null);
    table.decimal('projected_2017_OBP', 8, 3).defaultTo(null);
    ...
    table.decimal('projected_2017_SLG', 8, 3).defaultTo(0.00);
    table.decimal('projected_2017_OPS', 8, 3).defaultTo(0.00);
    table.decimal('projected_2017_IP', 5, 1).defaultTo(0.0);
    ...
    table.decimal('projected_2017_ERA', 8, 2).defaultTo(0.0);
    table.decimal('projected_2017_WHIP', 8, 2).defaultTo(0.0);
